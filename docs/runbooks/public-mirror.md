...
# 2. GitHub に public リポジトリを作成し、ミラーの origin に登録
gh repo create <owner>/local-infra --public --description "Personal GitOps homelab: ISO 25010/25019 quality evaluation platform on k3d (filtered public mirror)"
git -C ..\local-infra-public remote add origin https://github.com/<owner>/local-infra.git
